...
SELECT * FROM Customers WHERE Country LIKE '%A%'; --A enthalten (beliebig viele Zeichen sind auch 0 Zeichen -> Andorra)
...
SELECT * FROM Customers WHERE PostalCode LIKE '[0-9][0-9][0-9][0-9]'; --Alle Postleitzahlen die 4-Stellig und numerisch sind
